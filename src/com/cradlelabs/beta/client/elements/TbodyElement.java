package com.cradlelabs.beta.client.elements;
...
public class TbodyElement extends Element{
	 ...
	 */
	   ...
	   */
	  public static TbodyElement as(Element elem) {
	    assert is(elem);
	    return (TbodyElement) elem;
	  }
